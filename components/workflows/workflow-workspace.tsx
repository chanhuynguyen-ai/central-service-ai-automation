    ...
    <div className="grid items-start gap-5 xl:grid-cols-[minmax(250px,0.65fr)_minmax(0,1.35fr)]">
      ...
      <div className="space-y-4">{detail ? <>
        <article className="rounded-2xl border border-slate-200 bg-white p-5 md:p-7">
          ...
          {detail.status === "approved" ? <p className="mt-3 rounded-lg bg-emerald-50 p-3 text-sm text-emerald-800">{detail.fulfillment_state === "queued" ? "Approval completed. Service work is queued for the responsible service team." : "Approval completed. Service fulfillment remains a separate lifecycle."}</p> : null}
